...
//     {
//         if(xm.readyState === 4 && xm.status === 200)console.log(xm.responseText);
//     };
//     xm.send();
// }

document.addEventListener('DOMContentLoaded',() =>{
    let elemento2 = $("#hjquery");
    let jorge = $("#jorge");
    
   $("#entenderan").on('click',function(){
    alert("entendi");
   })
    ...
    elemento2.css("color","#1b00db");
    elemento2.css("font-size","50px");
    jorge.css("color","#4d4a62");
    jorge.css("font-size","25px");
    jorge.text("MecatronicosRD");
